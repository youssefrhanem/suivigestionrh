...
<head>
    ...
    <title>List des gendarmes Dotee</title>
    <!-- Bootstrap Core CSS -->
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">List des gendarmes Dotee avec des badge</h4>
            ...
            <div class="table-responsive m-t-40">
                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <c:forEach items="${profile}" var="profile">
                        <tr>
                            <td>${profile.badge.id}</td>
                            <th>${profile.firstname}</th>
                            <th>${profile.lastname}</th>
                            <th>${profile.matricule}</th>
                            <th>${profile.section.section}</th>
                            <th>${profile.service.service}</th>
                            <td>${profile.badge.nrSerie}</td>
                            <td>${profile.badge.typeBadge.type}</td>
                            <td>${profile.badge.activation}</td>
                            <td>
                                <a href="delete-badge.html?id=${profile.badge.id}&pid=${profile.id}">delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
