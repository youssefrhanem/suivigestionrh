...
<div class="col-lg-12">
    <div class="card card-outline-info">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Formullaire de modification des Users</h4>
        </div>
        <div class="card-body">
            <form method="post" action="modifier-user.html?id=<c:out value="${user.id}"/>">
                <div class="form-body">
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<c:out value="${user.nom}"/>" name="nom" id="firstName" class="form-control" placeholder="Nom"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<c:out value="${user.prenom}"/>" name="prenom" id="lastName" class="form-control form-control"
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<c:out value="${user.name}"/>"  name="username" id="userName" class="form-control" placeholder="Nom"
                                       required data-validation-required-message="This field is required">
                                <small class="form-control-feedback"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="service" class="form-control select2 form-control">
                                    <option value="<c:out value="${user.service.id}"/>"><c:out value="${user.service.service}"/></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Répéter le Nouveau Mots de Passe</label>
                                <div class="controls">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="authority" class="form-control select2 form-control">
                                    ...
                                    <c:forEach items="${user.authorities}" var="userauthority">
                                        <option value="${userauthority.id}">${fn:toUpperCase(userauthority.name)}</option>
                                    </c:forEach>
